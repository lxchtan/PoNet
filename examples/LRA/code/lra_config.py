...
config = {
    "listops":{
        ...
        "extra_attn_config":{
            ...
            "ponet":{"attention_grad_checkpointing":False, "segment_num":64},
            "fnet":{"attention_grad_checkpointing":False},
    ...
    "image":{
        ...
        "extra_attn_config":{
            ...
            "nystrom-128":{"attention_grad_checkpointing":False, "num_landmarks":128, "conv_kernel_size":35},
            "nystrom-256":{"attention_grad_checkpointing":False, "num_landmarks":256, "conv_kernel_size":35},
            "ponet":{"attention_grad_checkpointing":False, "segment_num":32},
            "fnet":{"attention_grad_checkpointing":False},
            "linformer-256":{"attention_grad_checkpointing":False, "linformer_k":256},
            "reformer-2":{"attention_grad_checkpointing":False, "num_hash":2},
            "performer-256":{"attention_grad_checkpointing":False, "rp_dim":256, "kernel_type":"relu"},
    ...
    "pathfinder32":{
        ...
        "extra_attn_config":{
            ...
            "nystrom-128":{"attention_grad_checkpointing":False, "num_landmarks":128, "conv_kernel_size":35},
            "nystrom-256":{"attention_grad_checkpointing":False, "num_landmarks":256, "conv_kernel_size":35},
            "ponet":{"attention_grad_checkpointing":False, "segment_num":1},
            "fnet":{"attention_grad_checkpointing":False},
            "linformer-256":{"attention_grad_checkpointing":False, "linformer_k":256},
            "reformer-2":{"attention_grad_checkpointing":False, "num_hash":2},
            "performer-256":{"attention_grad_checkpointing":False, "rp_dim":256, "kernel_type":"relu"},
    ...
    "text":{
        ...
        "extra_attn_config":{
            ...
            "nystrom-128":{"attention_grad_checkpointing":False, "num_landmarks":128, "conv_kernel_size":35},
            "nystrom-256":{"attention_grad_checkpointing":False, "num_landmarks":256, "conv_kernel_size":35},
            "ponet":{"attention_grad_checkpointing":False, "segment_num":4096}, # Here we write down 4096 for the function get_segment_index. Actually segment num is 2048.
            "fnet":{"attention_grad_checkpointing":False},
            "linformer-256":{"attention_grad_checkpointing":False, "linformer_k":256},
            "reformer-2":{"attention_grad_checkpointing":False, "num_hash":2},
            "performer-256":{"attention_grad_checkpointing":False, "rp_dim":256, "kernel_type":"relu"},
