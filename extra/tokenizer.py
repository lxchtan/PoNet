        ...
        if needs_to_be_padded:
            ...
            if self.padding_side == "right":
                ...
                if "segment_ids" in encoded_inputs:
                    encoded_inputs["segment_ids"] = encoded_inputs["segment_ids"] + [encoded_inputs["segment_ids"][-1]+1] * difference
                ...
                if "segment_ids" in encoded_inputs:
                    encoded_inputs["segment_ids"] = [encoded_inputs["segment_ids"][-1]+1] * difference + encoded_inputs["segment_ids"]
                if "special_tokens_mask" in encoded_inputs:
